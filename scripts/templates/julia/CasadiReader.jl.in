module CasadiReader
using Mmap
export Document, read_casadi, read_resource, loads, json, data, blob_size, read_blob
...
function loads(text::AbstractString; type = "", options...)
