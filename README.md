...
Julia additionally ships a broad corpus generated by
`scripts/generate-julia-fixtures.py`, with JSON references checked by ordinary
`Pkg.test()`. CI measures runtime and generated-decoder coverage and uploads it
to Codecov; see [Julia tests and coverage](julia/README.md#tests-and-coverage).
