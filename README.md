...
Julia is a native Julia implementation using JSON.jl and the Mmap standard library:
...
The Julia release archive can also be extracted and installed with
`Pkg.develop(path="/path/to/CasadiReader")`. General registry registration is
separate; URL installation works without it.
